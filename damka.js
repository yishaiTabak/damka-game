...
import { UICheckers } from "./UICheckers.js";
const rend = new UICheckers()
rend.renderUi()
...
//     game.play(pieces,myboard,game.isWhiteTurn,game.lastClick, destinationRow,destinationColumn)
//     if(game.isBlackWon) {
//         gameOverMassage.innerHTML = "game over!<br> black won"
//         gameOverContainer.className = 'modal-container'
//     }
//     else if(game.isWhiteWon) {
...
//         board[rowIndex][columnIndex].className = 'shadow-square'
//         for(let x = 0; x<8;x++)
//             for(let y =0;y<8;y++) 
...
// לעשות מחקלה חדשה לכל הui
// debedency injection
// *thereIsAnotherCapture
// לפרק לקונסטים קצרים את כל התנאים הארוכים
// הפרדה מוחלטת בין UI ללוגיקה
// 